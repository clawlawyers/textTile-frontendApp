...
const LeftoverstockproductwiseScreen: React.FC<
  LeftoverstockproductwiseScreenProps
> = ({navigation}) => {
      ...
      <View className="flex-1 px-5">
        ...
        <ScrollView contentContainerStyle={{flexGrow: 1}}>
          <View className="bg-[#D6872A] rounded-xl p-4 mb-5">
            ...
            <View className="flex-row  px-1 py-19">
        ...
        <View className="absolute bottom-0 left-0 right-0 px-5 pb-5">
          <TouchableOpacity
            onPress={() => navigation.navigate('LeftoverstockDesignwiseScreen')}
