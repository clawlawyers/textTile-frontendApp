...
const MonthlyDesignwiseOrdersScreen: React.FC<
  MonthlyDesignwiseOrdersScreenProps
> = ({navigation}) => {
    ...
    <SafeAreaView
      ...
      <View className="flex-1 px-5">
        ...
        <View className="mb-5">
          <View className="bg-[#D6872A] rounded-lg mb-4">
            <Dropdown
              ...
              labelField="label"
              valueField="value"
              placeholder={'Monthly Design wise order percentage'}
        ...
        <View className="absolute bottom-0 left-0 right-0 px-5 pb-5">
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('MonthlyAdvanceVsDuesProductwiseScreen')
            }
