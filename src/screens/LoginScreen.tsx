...
const LoginScreen = ({navigation}: LoginProps) => {
  ...
  return (
    <View className="flex-1 bg-[#FAD9B3] px-6 pt-16 flex">
      {/* Back Button */}
      <TouchableOpacity
      ...
      <View className="flex-row items-center justify-center mb-6">
        <Text className={`mr-2 ${!isUserLogin ? 'font-bold' : ''} text-black`}>
          Manager
        </Text>
        <Switch
      ...
      {/* Create Account */}
      <View className="bottom-4 flex-row justify-center mt-auto">
